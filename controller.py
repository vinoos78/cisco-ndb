...
class Controller:
    ...
    def get_rest_monitor_add_port_device_body(self, switch=None, port=None, monitor_port_type=None):
        ...
        converted_port = self.getNDBConvertedPortNamesWrapper(_type=_type, swPortName=port, node_id=node_id)
    ...
    def get_rest_monitor_device_body(self, switch=None, port=None):
        ...
        Body = {
           "name": "%s" % name,
           "icon": "monitor1",
           "nodeConnector": "%s|%s@%s|%s" % (_type, converted_port, _type, node_id),
           "monitorPortGroup": [],
           "creatorUser": "admin",
    ...
    def get_rest_connection_body(self,switch=None, con_name=None, port=None, allowFilterList=[], denyFilterList=[], monitorDeviceList=[], priority=None):
        ...
        Body = {
           ...
           "sourcePort": [
             "%s|%s@%s|%s" % (_type, converted_port, _type, node_id),
           ],
    ...
    def getNDBConvertedPortNamesWrapper(self, _type=None, swPortName=None, node_id=None):
        if _type == "OF":
            conDict = dict()
            conDict = self.getNDBNodeConnectorProperties(nodeType=_type, nodeID=node_id)
